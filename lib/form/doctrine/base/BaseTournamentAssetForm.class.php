...
/**
 * TournamentAsset form base class.
 *
 * @method TournamentAsset getObject() Returns the current form's model object
 *
 * @package    futebol
 * @subpackage form
 ...
 */
abstract class BaseTournamentAssetForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tournament_asset[%s]');
