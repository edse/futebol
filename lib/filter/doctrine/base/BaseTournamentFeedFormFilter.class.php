...
/**
 * TournamentFeed filter form base class.
 *
 * @package    futebol
 * @subpackage filter
 ...
 */
abstract class BaseTournamentFeedFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tournament_feed_filters[%s]');
