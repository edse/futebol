...
/**
 * TournamentAsset filter form base class.
 *
 * @package    futebol
 * @subpackage filter
 ...
 */
abstract class BaseTournamentAssetFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tournament_asset_filters[%s]');
