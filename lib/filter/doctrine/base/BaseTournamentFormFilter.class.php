...
abstract class BaseTournamentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'edition_name'      => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'edition_slug'      => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'edition_ext_id'    => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'edition_name'      => new sfValidatorPass(array('required' => false)),
      'edition_slug'      => new sfValidatorPass(array('required' => false)),
      'edition_ext_id'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
