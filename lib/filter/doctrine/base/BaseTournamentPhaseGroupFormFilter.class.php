...
/**
 * TournamentPhaseGroup filter form base class.
 *
 * @package    futebol
 * @subpackage filter
 ...
 */
abstract class BaseTournamentPhaseGroupFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'tournament_phase_group_ext_id' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      'tournament_phase_group_ext_id' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('tournament_phase_group_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      'id'                            => 'Number',
      'tournament_phase_group_ext_id' => 'Number',
