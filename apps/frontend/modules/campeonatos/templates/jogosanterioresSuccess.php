...
<div data-role="page" class="type-interior">
  ...
  <div data-role="content" data-theme="c">
    <div class="content-primary">
      ...
      <div data-role="navbar" data-theme="c">
        <ul>
          <li><a href="<?php echo url_for('@default?module=campeonatos&action=jogos&slug='.$campeonato->getSlug()) ?>">Próximos Jogos</a></li>
          <li><a href="<?php echo url_for('@default?module=campeonatos&action=jogos-anteriores&slug='.$campeonato->getSlug()) ?>" class="ui-btn-active">Jogos Anteriores</a></li>
        </ul>
      </div>
