  ...
  <div data-role="content" data-theme="c">
    <div class="content-primary">
      ...
      <?php foreach($classificacao as $c): ?>
        <tr class="linha-classificacao" rel="<?php echo $c->Team->getSlug()?>" data="/uploads/assets/teams/<?php echo $c->Team->getLogo()?>"><td class="primeira faixa1" rel="grafico-posicao"><div class=""><?php echo $c->getRank()?></div></td><td class="time "><?php echo $c->Team->getName()?></td><td class="coluna-p" rel="jogos-pontos"><div><?php echo $c->getPoints()?></div></td><td class="coluna-j" rel="jogos-jogos"><div><?php echo $c->getGames()?></div></td><td class="coluna-v" rel="jogos-vitorias"><div><?php echo $c->getWins()?></div></td><td class="coluna-e" rel="jogos-empates"><div><?php echo $c->getDraws()?></div></td><td class="coluna-d" rel="jogos-derrotas"><div><?php echo $c->getDefeats()?></div></td><td class="coluna-gp" rel="gols-pro"><div><?php echo $c->getScoreFor()?></div></td><td class="coluna-gc" rel="gols-contra"><div><?php echo $c->getScoreAgainst()?></div></td><td class="coluna-sg" rel="grafico-saldo"><div><?php echo $c->getScoreDifference()?></div></td><td class="coluna-a" rel="grafico-aproveitamento"><div><?php echo $c->getRate()?></div></td></tr>
      <?php endforeach; ?>
      </tbody></table>
